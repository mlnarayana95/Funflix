...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 10, 2019 at 07:32 PM
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `street`, `city`, `postal_code`, `province`, `country`, `phone`, `email`, `password`, `created_at`, `updated_at`) VALUES
(1, 'Narain', 'Madabhushi', '#406, 595, River Avenue', 'Winnipeg', 'R3L0E6', 'Manitoba', 'Canada', '2044303747', 'mlnarayana95@gmail.com', '$2y$10$C7HdzETmAWr5rziDNGyvoeCRHV1NgApnttwoDIQN2tpAGtBDEnlDq', '2019-08-22 00:19:35', NULL),
(13, 'Narayana', 'Mada', '406, 595, River Avenue', 'Winnipeg', 'R3L0E6', 'Manitoba', 'Canada', '2044303747', 'narayana@gmail.com', '$2y$10$1DKbHEUDWDDN25H1ju9IOurv1mmmn36UVQjIH7/FQecT8Y4ieFuP2', '2019-08-22 17:05:58', NULL),
(14, 'Narain', 'Madabhushi', '406, 595, River Avenue', 'Winnipeg', 'R3L0E6', 'Manitoba', 'Canada', '2044303747', 'mlnarna95@gmail.com', '$2y$10$mill2uk0RLrqCA1950dvpea5qwcx15H2Wl3sbWVmR.4MFof7L7.aq', '2019-08-22 19:53:45', NULL),
(15, 'Narain', 'Narain', '406, 595, River Avenue', 'Winnipeg', 'R3L0E6', 'Manitoba', 'Canada', '2044303747', 'rayana95@gmail.com', '$2y$10$rQPWeV2Eb4R0ZLqphUBaAekGGC.Itae7cv.6VaEUBpl81KYBGiln6', '2019-08-22 21:13:54', NULL),
(16, 'Lloyd', 'Guadez', '624 Broadway', 'Winnipeg', 'R3G2F9', 'Manitoba', 'Canada', '2048989055', 'lguadez@gmail.com', '$2y$10$iReRtp2OdkMdXVyEN.75HuZO9tG4WW5Ucu3y9Lyd6XNLb7nAi.i0K', '2019-08-23 00:30:01', NULL),
(17, 'Narain', 'Madabhushi', '#406, 595, River Avenue', 'Winnipeg', 'R3L0E6', 'Manitoba', 'Canada', '2044303747', 'mlnarayana95.a@gmail.com', '$2y$10$ZdLeIpeQnn8hu4UlECpLeutNjKYXIB0In7Sf8GYqEEOJ8K3T3Zr7e', '2019-08-23 00:44:40', NULL),
(23, 'Narain', 'Madabhushi', '#406, 595, River Avenue', 'Winnipeg', 'R3L0E6', 'Manitoba', 'Canada', '2044303747', 'nain95@gmail.com', '$2y$10$5z.leamEnPBK2us7P9zonO.dfZetZ66jcY88qL.xGF1jjz/JU18Ee', '2019-09-10 12:59:58', NULL),
(24, 'Narain', 'Madabhushi', '#406, 595, River Avenue', 'Winnipeg', 'R3L0E6', 'Manitoba', 'Canada', '2044303747', 'nainain95@gmail.com', '$2y$10$SuiQbtnaYZAYOk13jBUvCOoYosPCvKeZPAQFuW/fKVYuAVxZLf2Ju', '2019-09-10 13:57:54', NULL);
...
(1, 'FRIENDS', 'TVSHOW', 'english', '9.0', 'Follows the personal and professional lives of six twenty to thirty-something-year-old friends living in Manhattan.', ' Three young men and three young women -- of the BFF kind -- live in the same apartment complex and face life and love in New York. ', 'friends', 22, 'Gary Halvorson', 10, '1994-09-24 00:00:00', '2019-07-24 03:00:33', NULL),
(2, 'WHEN THEY SEE US', 'TVSHOW', 'english', '9.1', 'About the Central Park Five Incident', 'Five teens from Harlem become trapped in a nightmare when they\'re falsely accused of a brutal attack in Central Park. Based on the true story.', 'whentheyseeus', 296, 'Ava DuVernay', 1, '2019-05-31 00:00:00', '2019-07-24 03:52:50', NULL),
(3, 'UNFORGOTTEN', 'TVSHOW', 'english', '8.2', 'The detectives are on a mission to uncover the mystery behind an unsolved murder that occurred 39 years ago', 'London detectives investigate crimes from the past, unravelling secrets left buried for years', 'unforgotten', 45, 'Andy Wilson', 3, '2015-10-01 00:00:00', '2019-07-24 03:52:50', NULL),
